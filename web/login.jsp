...
<html class="js cssanimations"><head>
    ...
    <script type="text/javascript" async="" defer="" src="//yui-ssl.smartgslb.com/yui.js"></script><script type="text/javascript">
    var _paq = _paq || [];
    ...
    <div class="am-center topbar">
        ...
        <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
            ...
            <div class="am-topbar-right">
                <div class="am-topbar-right">
                    <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="location.href='login.jsp';">登录</button>
                    <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="location.href='register.jsp';">注册</button>
                </div>
            </div>
...
<div class="am-g am-g-fixed">
        ...
        <div class="am-u-sm-6">
            <form action="/User?action=login" method="POST" class="am-form" id="biuform">
                <fieldset>
                    ...
                    <input type="submit" value="登录" class="am-btn am-round am-btn-primary" id="dosubmit"> <input type="button" class="am-btn am-round am-btn-primary" onclick="javascript:location.href='/forget.jsp';" value="忘记密码Orz">
                </fieldset>
            </form>
        </div>
    </div>
    <!--div class="grid" style="margin:.625rem 0;">
        <div class="row cells1">
            ...
            <form method="POST" action="/User/doLogin" id="biuform">
            <div class="cell colspan1">
                <div class="input-control modern text iconic">
                    <input type="text" name="email" />
                    <span class="label">邮箱</span>
                    <span class="informer">请输入邮箱</span>
            ...
            <div class="cell colspan1">
                <h2>可以使用 Moe.Re 账号直接登录</h2>
            </div>
            <div class="cell colspan1">
                <input type="submit" class="button primary" id="dosubmit" value="登录" />
                <input type="button" class="button primary" onclick="javascript:location.href='/User/forgotPw';" value="忘记密码Orz" />
            </div>
        </div>
    </div-->
    <script>
    ...
    <div class="am-u-sm-12">
        <h6>© 2013-2019 MoeSound 分享高音质 ACG 音乐 <a href="/Index/about">关于本站</a></h6>
    </div>
...
<iframe id="i_iframe" src="https://biu.moe/iframe.html#changeURI|/User/login|0.12324680019677836" style="display:none;">
    <div class="am-modal am-modal-alert" tabindex="-1" id="biu-alert">
    ...
    <script type="text/javascript" src="https://tajs.qq.com/stats?sId=52366372" charset="UTF-8"></script><div style="display:none;"><script src="https://s11.cnzz.com/z_stat.php?id=1256971235&web_id=1256971235" language="JavaScript"></script></div>
</body>
