        ...
        <div class="am-u-sm-6">
            ...
            <form action="/Info" method="post">
                ...
                <fieldset>
                    ...
                    <input name="imagePath" value="${requestScope.imagePath}" hidden="hidden">
                    <input name="musicPath" value="${requestScope.musicPath}" hidden="hidden">
                    <div class="am-form-group">
                        歌曲名：
